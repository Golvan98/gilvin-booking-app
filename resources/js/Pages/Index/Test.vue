...
<div class="ml-4 mt-2 h-1/6 text-white">  <button data-modal-target="requests-modal" data-modal-toggle="requests-modal"  class="bg-red-700 px-2 py-1 rounded-sm">  Delete Account </button>  </div>
